        ...
        try {
            ...
            if (cart != null) {
                ...
                if (checkRemove) {
                    ...
                    url = SUCCESS;
                    request.setAttribute("MESSAGE", "Remove succesfully " + productID);
                    request.setAttribute("TITLE", "Remove success!!!");
                    request.setAttribute("ICON", "success");
                    request.setAttribute("BUTTON", "Continue");
                } else {
                    request.setAttribute("MESSAGE", "Remove failed " + productID);
                    request.setAttribute("TITLE", "Remove failed!!!");
