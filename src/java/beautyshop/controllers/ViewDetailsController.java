 ...
 * @author LeHoangTrong
 */
@WebServlet(name = "ViewDetailsController", urlPatterns = {"/ViewDetailsController"})
public class ViewDetailsController extends HttpServlet {

    private static final String ERROR = "ViewOrderController";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<ProductDTO> list = dao.getListProduct(orderID);
            if (list.size() > 0) {
                request.setAttribute("LIST_PRODUCT", list);
                url = SUCCESS;
            }
        } catch (Exception e) {
            log("ERROR at ViewDetailsController: " + e.getMessage());
        } finally {
